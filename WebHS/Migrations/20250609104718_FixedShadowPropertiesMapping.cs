...
{
    /// <inheritdoc />
    public partial class FixedShadowPropertiesMapping : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Homestays_AspNetUsers_HostId",
                        column: x => x.HostId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BlockedDates_Homestays_HomestayId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomestayPricings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HomestayPricings_Homestays_HomestayId",
                        column: x => x.HomestayId,
                        principalTable: "Homestays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Homestays_IsActive",
                table: "Homestays",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_Homestays_IsApproved",
                table: "Homestays",
                column: "IsApproved");
