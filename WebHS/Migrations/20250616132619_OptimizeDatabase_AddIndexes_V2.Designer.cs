...
namespace WebHS.Migrations
{
    ...
    [Migration("20250616132619_OptimizeDatabase_AddIndexes_V2")]
    partial class OptimizeDatabase_AddIndexes_V2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebHS.Models.HomestayPricing", b =>
                {
                    ...
                    b.ToTable("HomestayPricings", t =>
                        {
                            t.HasCheckConstraint("CK_HomestayPricing_PricePerNight", "[PricePerNight] >= 0");
                        });
                });
            ...
            modelBuilder.Entity("WebHS.Models.Message", b =>
                {
                    ...
                    b.HasIndex("SenderId", "ReceiverId", "IsRead")
                        .HasDatabaseName("IX_Messages_Sender_Receiver_Read");

                    b.ToTable("Messages");
                });

            modelBuilder.Entity("WebHS.Models.MessageTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebHS.Models.Payment", b =>
                {
                    ...
                    b.HasIndex("CreatedAt", "Status", "PaymentMethod")
            ...
            modelBuilder.Entity("WebHS.Models.Promotion", b =>
                {
                    ...
                    b.HasIndex("IsActive", "StartDate", "EndDate")
                        .HasDatabaseName("IX_Promotions_Active_Period");
            ...
            modelBuilder.Entity("WebHS.Models.User", b =>
                {
                    ...
                    b.HasIndex("IsHost")
                        .HasDatabaseName("IX_Users_IsHost");
